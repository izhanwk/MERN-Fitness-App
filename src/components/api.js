...
//     const code = error?.response?.data?.code; // <-- backend should send this
//     const isRefreshCall = original?.url?.includes("/refresh-token");

//     // If the server says the session/refresh is revoked -> NO REFRESH, force logout
...
//       ) {
//         error._forceLogout = true; // flag for caller
//         return Promise.reject(error);
//       }
//     }

//     // Try refresh ONLY for generic 401/403 (not the refresh endpoint itself)
//     if (
...
//               e._forceLogout = true; // refresh itself was invalid/revoked
//             }
//             throw e;
//           } finally {
//             isRefreshing = false;
